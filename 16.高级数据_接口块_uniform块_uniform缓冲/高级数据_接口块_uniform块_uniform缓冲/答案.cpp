...
int main()
{
	...
	Shader shaderRed("shaders/myubo.vs", "shaders/ubo_red.frag");
	Shader shaderGreen("shaders/myubo.vs", "shaders/ubo_green.frag");
	Shader shaderBlue("shaders/myubo.vs", "shaders/ubo_blue.frag");
	Shader shaderYellow("shaders/myubo.vs", "shaders/ubo_yellow.frag");

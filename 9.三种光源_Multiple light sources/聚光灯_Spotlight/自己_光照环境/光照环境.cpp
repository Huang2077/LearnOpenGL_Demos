...
int main()
{
   ...
   //设置顶点数组/////////////////////////////////////////////////////////////////////////////////////
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		GLint lightDirectionLoc = glGetUniformLocation(worldProgram.Program, "light.direction");
		GLint lightCutoffLoc = glGetUniformLocation(worldProgram.Program, "light.cutoff");
		GLint lightOutcutoffLoc = glGetUniformLocation(worldProgram.Program, "light.outcutoff");
		...
		glUniform1f(lightCutoffLoc,glm::cos(glm::radians(10.5f)));
		glUniform1f(lightOutcutoffLoc, glm::cos(glm::radians(15.5f)));

...
int main()
{
	...
	// 创建world_shader//////////////////////////////////////////////
	Shader worldProgram = Shader("world.vs", "world.frag", "world.gs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(DirLightDiffuseLoc, 1.0f, 1.0f, 1.0f);// 让我们把这个光调暗一点，这样会看起来更自然
		...
		//传time
		glUniform1f(glGetUniformLocation(worldProgram.Program, "time"), glfwGetTime());

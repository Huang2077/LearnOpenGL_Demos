...
glm::vec3 lightPos = glm::vec3(5.0f, 5.0f, 5.0f);//灯在世界空间中的位置
...
int main()
{
   ...
   //设置顶点数组/////////////////////////////////////////////////////////////////////////////////////
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		GLint lightKcLoc = glGetUniformLocation(worldProgram.Program, "light.Kc");
		GLint lightKlLoc = glGetUniformLocation(worldProgram.Program, "light.Kl");
		GLint lightKqLoc = glGetUniformLocation(worldProgram.Program, "light.Kq");
		...
		glUniform1f(lightKlLoc, 0.09f);
		glUniform1f(lightKqLoc, 0.032f);
